...
参考自 ：https://www.orzlee.com/web-development/2021/03/03/haptear-jingdong-signin-scriptjingxi-factory-solves-the-problem-of-unable-to-signin.html
...
[task_local]
#京喜工厂
10 * * * * https://raw.githubusercontent.com/haptear/jdauto/master/jd_dreamFactory.js, tag=京喜工厂, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_dreamFactory.js,tag=京喜工厂

===============Surge=================
京喜工厂 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_dreamFactory.js

============小火箭=========
京喜工厂 = type=cron,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_dreamFactory.js, cronexpr="10 * * * *", timeout=3600, enable=true
...
async function joinLeaderTuan() {
  ...
  if ($.authorTuanIds && $.authorTuanIds.length) {
    for (let tuanId of $.authorTuanIds) {
      if (!tuanId) continue
      if (!$.canHelp) break;
      console.log(`\n账号${$.UserName} 参加作者haptear的团 【${tuanId}】`);
