...
[task_local]
#京东炸年兽🧨
0 9,12,20,21 * * * https://raw.githubusercontent.com/haptear/jdauto/master/jd_nian.js, tag=京东炸年兽🧨, img-url=https://raw.githubusercontent.com/yogayyy/Scripts/main/Icon/lxk0301/jd_nian.png, enabled=true

================Loon==============
[Script]
cron "0 9,12,20,21 * * *" script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_nian.js,tag=京东炸年兽🧨

===============Surge=================
京东炸年兽🧨 = type=cron,cronexp="0 9,12,20,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_nian.js

============小火箭=========
京东炸年兽🧨 = type=cron,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_nian.js, cronexpr="0 9,12,20,21 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东炸年兽🧨');
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.code === 0 && data.data && data.data.bizCode === 0) {
              ...
              if (info.dayAward) {
                console.log(`白天关卡：${info.dayAward}元红包，完成进度 ${info.dayTotalValue || 0}/${info.dayTargetSell}`)
                console.log(`团队红包：${data.data.result.groupInfo.groupAward}`)
              }
              else {
