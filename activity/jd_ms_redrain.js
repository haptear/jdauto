...
更新地址：https://raw.githubusercontent.com/haptear/jdauto/master/jd_ms_redrain.js
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#秒杀红包雨
10 7 * * * https://raw.githubusercontent.com/haptear/jdauto/master/jd_ms_redrain.js, tag=秒杀红包雨, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_redPacket.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_ms_redrain.js, tag=秒杀红包雨

===============Surge=================
秒杀红包雨 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_ms_redrain.js

============小火箭=========
秒杀红包雨 = type=cron,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_ms_redrain.js, cronexpr="10 7 * * *", timeout=3600, enable=true
 */
const $ = new Env('秒杀红包雨');
...
function showMsg() {
  return new Promise(async resolve => {
    ...
    if (nowTime > new Date('2020/12/31 23:59:59+08:00').getTime()) {
      $.msg($.name, '活动已结束', `咱江湖再见\nhttps://github.com/haptear/jdauto`, {"open-url": "https://github.com/haptear/jdauto"});
      if ($.isNode()) await notify.sendNotify($.name + '活动已结束', `咱江湖再见\n https://github.com/haptear/jdauto`)
    } else {
