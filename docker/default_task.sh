...
echo "发送通知"
export NOTIFY_CONTENT="2021-02-21更新 https://gitee.com/haptear/jdauto仓库被迫私有，需重新更新一下镜像：https://hub.docker.com/r/haptear/jdauto，(注：国内第三方镜像目前可能不是最新请使用hub.docker.com镜像，docker-compose.yml的REPO_URL记得修改)后续可同步更新jd_script仓库最新脚本"
cd /scripts/docker
