    ...
    return __generator(this, function (_x) {
        switch (_x.label) {
            ...
            case 7:
                ...
                return [3 /*break*/, 8];
            case 8:
                token = TS_USER_AGENTS_1.getJxToken(cookie);
            ...
            case 25: return [4 /*yield*/, TS_USER_AGENTS_1.wait(3000)];
            case 26:
                _x.sent();
                return [3 /*break*/, 11];
            ...
            case 37:
                i_1++;
                return [3 /*break*/, 29];
            case 38: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 珍珠领奖
            ];
            case 39:
                _x.sent();
            ...
            case 44:
                _c++;
                return [3 /*break*/, 41];
            case 45: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 签到 助力奖励
            ];
            case 46:
                _x.sent();
            ...
            case 57:
                console.log('今日已经签到');
                _x.label = 58;
            case 58: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 船来了
            ];
            case 59:
                _x.sent();
            ...
            case 69:
                ...
                _x.label = 70;
            case 70: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 71:
                _x.sent();
                _x.label = 72;
            ...
            case 83:
                j++;
                return [3 /*break*/, 80];
            case 84: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 任务➡️
            ];
            case 85:
                _x.sent();
            ...
            case 89:
                res = _x.sent();
                return [4 /*yield*/, TS_USER_AGENTS_1.wait(t.dwLookTime * 1000)];
            case 90:
                _x.sent();
                if (res.ret === 0) {
                    console.log('任务完成');
            ...
            case 102:
                ...
                _x.label = 103;
            case 103: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 导游
            ];
            case 104:
                _x.sent();
            ...
            case 110:
                _r++;
                return [3 /*break*/, 107];
            case 111: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)
                // 任务⬇️
            ];
            case 112:
                _x.sent();
            ...
            case 120:
                _t++;
                return [3 /*break*/, 114];
            case 121: return [4 /*yield*/, TS_USER_AGENTS_1.wait(2000)];
            case 122:
                _x.sent();
