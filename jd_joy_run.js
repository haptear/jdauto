...
宠汪汪助力获取Token = type=http-request,pattern=^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/user\/detail\?openId=, requires-body=1, max-size=0, script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_joy_run.js
...
http-response ^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/addUser\?code= script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_joy_run.js, requires-body=true, timeout=3600, tag=宠汪汪助力更新Token
http-request ^https:\/\/draw\.jdfcloud\.com(\/mirror)?\/\/api\/user\/user\/detail\?openId= script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_joy_run.js, requires-body=true, timeout=3600, tag=宠汪汪助力获取Token
 **/
