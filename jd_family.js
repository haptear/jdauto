...
[task_local]
#京东家庭号
1 12,23 * * * https://raw.githubusercontent.com/haptear/jdauto/master/jd_family.js, tag=京东家庭号, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_family.png, enabled=true

================Loon==============
[Script]
cron "1 12,23 * * *" script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_family.js,tag=京东家庭号

===============Surge=================
京东家庭号 = type=cron,cronexp="1 12,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_family.js

============小火箭=========
京东家庭号 = type=cron,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_family.js, cronexpr="1 12,23 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东家庭号');
