...
东东超市兑换奖品请使用此脚本 https://raw.githubusercontent.com/haptear/jdauto/master/jd_blueCoin.js
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
=================QuantumultX==============
[task_local]
#东东超市
11 * * * * https://raw.githubusercontent.com/haptear/jdauto/master/jd_superMarket.js, tag=东东超市, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
===========Loon===============
[Script]
cron "11 * * * *" script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_superMarket.js,tag=东东超市
=======Surge===========
东东超市 = type=cron,cronexp="11 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_superMarket.js
==============小火箭=============
东东超市 = type=cron,script-path=https://raw.githubusercontent.com/haptear/jdauto/master/jd_superMarket.js, cronexpr="11 * * * *", timeout=3600, enable=true
 */
const $ = new Env('东东超市');
...
async function businessCircleActivity() {
  ...
  if (businessCirclePKDetailRes && businessCirclePKDetailRes.data.bizCode === 0) {
    ...
    console.log(`您暂未加入商圈,现在给您加入haptear的商圈`);
    ...
    if (joinBusinessCircleRes.data.bizCode !== 0) {
      console.log(`您加入haptear的商圈失败，现在给您随机加入一个商圈`);
