    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 8:
                ...
                return [4 /*yield*/, shareCodesTool_1.jxfactory(emp)];
            case 9:
                sharecode = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    shareCodes = __spreadArray(__spreadArray([], shareCodesInternal), data.data);
                    return [3 /*break*/, 3];
                case 2:
                    e_2 = _a.sent();
                    shareCodes = __spreadArray([], shareCodesInternal);
                    return [3 /*break*/, 3];
